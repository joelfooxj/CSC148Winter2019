...
class _Node:
    ...
    to be used in this module by the LinkedList_new class, but not by client code.
...
class LinkedList_new:
    ...
    _length:
        The number of nodes in the LinkedList_new

    == Representation invariants ===
    _first:
        Should be a _Node object
    _length >= 0
    """
    ...
    def __init__(self, items: List) -> None:
        ...
        self._first = None
        self._length = 0
        # Try to use the insert function?
    ...
    def is_empty(self) -> bool:
        ...
        >>> LinkedList_new([]).is_empty()
        True
        >>> LinkedList_new([1, 2, 3]).is_empty()
        False
        """
    ...
    def count(self, item: Any) -> int:
        ...
        >>> lst = LinkedList_new([1, 2, 1, 3, 2, 1])
        >>> lst.count(1)
        3
        >>> lst.count(2)
        2
