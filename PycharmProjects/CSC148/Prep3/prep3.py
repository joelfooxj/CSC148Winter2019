...
class Employee:
    ...
    payments: A record of the dates of an employees' monthly payments
    """
    id_: int
    name: str
    payments: List[date]
    ...
    def total_pay(self) -> float:
        ...
        return len(self.payments)*self.get_monthly_payment()
